...
Why wouldn't you expect them to be exact? I think it's to do with differences between the risk sets (?). Need to mull over this more. It could be affected by covariates but I don't think it is. 
