...
for (var in names(rot_list)) {
  ...
  ## XXX NOTE: Change to precision weighting???? This would weight the outcome by the number of measurements
...
rec_dat$Model[rec_dat$Model == "measurement_adjusted"] <- "adjusted for within-person variation"
rec_dat <- do_plot_admin(rec_dat, mod_levels = c( "adjusted for within-person variation", "original"))
my_cols <- get_cols(2)
